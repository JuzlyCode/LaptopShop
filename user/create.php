        ...
        <div class="grid">
            <div class="form-login">
                ...
                <form class="form-flex" action="./create.php?action=create" method="Post" autocomplete="off">
                    ...
                    <?php if ($error !== false) { ?>
                    <h3 style="font-size:10px; margin:-8px 0 5px 0; color:red; text-transform: lowercase;"><?= $error ?>
                    </h3>
                    <?php } ?>
                    <div class="form-login__input-size">
                    ...
                    <h3 style="font-size:10px; margin:-8px 0 5px 0; color:red; text-transform: lowercase;">
                        <?= $errorPassword ?></h3>
                    <?php } ?>
                    <div class="form-login__input-size">
