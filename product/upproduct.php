...
<p class="in4mAlo" style="<?php if ($alo == "Sửa sản phẩm thành công!"){ ?> color: green;<?php }else{ ?>color:red;<?php } ?>"><?=$alo?></p>
</div>
                        <!-- end thong bao -->
...
<table class="table-upprd">
    ...
    <tr class="table-upprd__list">
        ...
        <td><textarea name="nameProduct" id="titleProductt" cols="30" rows="10"><?=$uploads['title']?></textarea></td>
    ...
    <tr class="table-upprd__list">
        ...
        <td><input type="number" class="upprd-input" name="discountProduct" value="<?=$uploads['discount']?>"><br /></td>
    </tr> 
    <tr class="table-upprd__list">
        <td class="table-upprd__item">Số lượng SP trong kho:</td>
        <td><input type="number" class="upprd-input" name="quantityProduct" value="<?=$uploads['quantity']?>"><br /></td>
    </tr>     
</table>
